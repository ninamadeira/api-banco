package com.madeira.apibanco.services.validation.utils;
...
public class Util {
	 ...
	 * 
	 */
	public static Integer getNumeroContaCorrente() {
		Random random = new Random();
		Integer conta = 1 + random.nextInt(999999);
		return conta;

	}
	/**
	 * Gera o score da Conta Corrente
	 * 
	 * @return
	 */
	public static Integer getScore() {
		Random random = new Random();
		Integer score = (Integer) random.nextInt(10);
		return score;
